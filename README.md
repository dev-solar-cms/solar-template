...
> État actuel : système de design commun en place (tokens, boutons/badges/pills, cartes produit/article), structure commune du thème (`header.php`, `footer.php`, mega menu) et page d'accueil (`front-page.php`) en cours de construction section par section — hero, produits vedettes, catégories (données WooCommerce réelles), notre histoire, témoignages et aperçu du blog (articles réels) sont en place. Voir [STRUCTURE.md](./STRUCTURE.md) pour le détail des fichiers.
