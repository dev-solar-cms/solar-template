...
> État actuel : système de design commun en place (tokens, boutons/badges/pills, cartes produit/article), structure commune du thème (`header.php`, `footer.php`, mega menu) et page d'accueil (`front-page.php`) complète : hero, produits vedettes, catégories (données WooCommerce réelles), notre histoire, témoignages, aperçu du blog (articles réels) et newsletter (inscription en base, traitée en AJAX). Voir [STRUCTURE.md](./STRUCTURE.md) pour le détail des fichiers.
